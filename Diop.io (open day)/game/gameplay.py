import pygame
import sys
from game.schermata_iniziale import mostra_schermata_iniziale
from game.vittoria import mostra_schermata_vittoria
from game.sconfitta import mostra_schermata_sconfitta
from game.impostazioni import *
from game.nemici import *
from game.genera_porta import genera_porta
from game.collisione_bordi import *
...
def gest_gameplay():
    ...
    while schermata_gioco:
        ...
        # disegna mario solo se all'interno della torcia
        if mario_visibile:
        ...
        if pausa:
            ...
            testo_pausa = font_pausa.render("PAUSA", True, BIANCO)
            schermo.blit(testo_pausa, (larghezza_schermo // 2 - testo_pausa.get_width() // 2, altezza_schermo // 2 - testo_pausa.get_height() // 2))
            pygame.display.flip()
            continue 
